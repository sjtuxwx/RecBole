...
def main():
    ...
    parser.add_argument("--output_root", default="/data/xwx/code/MiniOneRec/data/Amazon18")
    parser.add_argument("--data_path", default="/data/xwx/code/MiniOneRec/data/Amazon18/")
    args = parser.parse_args()

    data_path = os.path.join(args.data_path, args.dataset, f"{args.dataset}.emb-qwen2.5-td.npy")
